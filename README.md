...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/stackvana-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/stackvana-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11839&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/stackvana-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_arm64_python3.13.____cp313" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
pixi add stackvana stackvana-lsst_distrib
# for installing globally
pixi global install stackvana stackvana-lsst_distrib
```
...
It is possible to list all of the versions of `stackvana` available on your platform:
...
```
pixi search stackvana --channel conda-forge
```
