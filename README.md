...
Once the `conda-forge` channel has been enabled, `stackvana, stackvana-meas_algorithms` can be installed with `conda`:

```
conda install stackvana stackvana-meas_algorithms
```

or with `mamba`:

```
mamba install stackvana stackvana-meas_algorithms
```
